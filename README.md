...
> 💡 Unlike the official Exaroton bot, this bot gives you full control over who can access which commands using roles or user ID. By default, all users in your Discord server can use the commands, but this behavior is easily configurable in [roles_and_accesses](roles_and_accesses.py).
